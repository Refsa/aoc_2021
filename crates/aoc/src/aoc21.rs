...
impl Runner for AOC21 {
    ...
    fn run_p1(&self) -> usize {
        let mut board = Board::new(self.p1_start, self.p2_start, 1000, |roll| (roll % 100) + 1);
    ...
    fn run_p2(&self) -> usize {
        ...
        let board = QuantumBoard::new(self.p1_start, self.p2_start, 21);
...
fn sim_board(
    ...
    roll: u16,
    lookup: &mut HashMap<[u16; 5], [u128; 2]>,
) -> [u128; 2] {
    if roll > 0 {
...
impl QuantumBoard {
    fn new(p1: usize, p2: usize, end_score: u16) -> Self {
        QuantumBoard {
...
impl Board {
    fn new(p1: usize, p2: usize, end_score: u16, dice: fn(u16) -> u16) -> Self {
        Board {
            rolls: 0,
            players: [(p1 as u16, 0), (p2 as u16, 0)],
            dice: dice,
